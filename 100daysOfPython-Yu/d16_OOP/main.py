...
while is_turned_on:
    ...
    # c. The same should happen if another resource is depleted, e.g. milk or coffee.
        ...
        user_drink = coffeMenu.find_drink(user_drink_input)
        is_sufficient = coffeMaker.is_resource_sufficient(user_drink)
        ...
        if is_sufficient:
            is_payment = moneyMachine.make_payment(user_drink.cost)
            ...
            if is_payment:
                ...
                is_making_coffee = coffeMaker.make_coffee(user_drink)
